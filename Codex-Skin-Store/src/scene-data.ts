...
const ocean: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 130, name: '暴鲤龙', types: ['水', '飞行'], role: 'encounter', flavor: '一旦现身就会破坏一切，狂暴到把整片海域搅得天翻地覆。' },
...
const cave: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 95, name: '大岩蛇', types: ['岩石', '地面'], role: 'encounter', flavor: '在地下以 80 公里的时速掘进，坚硬的身躯能撞碎岩石。' },
    { id: 41, name: '超音蝠', types: ['毒', '飞行'], role: 'encounter', flavor: '没有眼睛，靠超声波在黑暗的洞穴里飞行觅食。' },
    { id: 50, name: '地鼠', types: ['地面'], role: 'encounter', flavor: '在地下挖洞生活，偶尔探出头来观察地面上的动静。' },
    { id: 74, name: '小拳石', types: ['岩石', '地面'], role: 'encounter', flavor: '圆圆的石头身体，常被人误当作普通石头踢来踢去。' },
    { id: 94, name: '耿鬼', types: ['幽灵', '毒'], role: 'encounter', flavor: '躲在阴影里等待猎物的紫影，洞穴深处最危险的访客。' },
  ],
  starterLine: [
    { id: 374, name: '铁哑铃', types: ['钢', '超能力'], role: 'encounter', flavor: '靠磁力浮在空中，成群聚集时会共享脑电波。' },
    { id: 375, name: '金属怪', types: ['钢', '超能力'], role: 'encounter', flavor: '两只铁哑铃合体而成，四只手臂能抓住飞行中的猎物。' },
    { id: 376, name: '巨金怪', types: ['钢', '超能力'], role: 'encounter', flavor: '拥有超越超级计算机的头脑，是洞穴深处的智慧守护者。' },
  ],
  legendaries: [
    { id: 377, name: '雷吉洛克', types: ['岩石'], role: 'legendary', flavor: '由岩石构成的传说巨人，受损的身体会自行修复。' },
    { id: 378, name: '雷吉艾斯', types: ['冰'], role: 'legendary', flavor: '冰之巨人，身边永远环绕着零下 200 度的冷气。' },
    { id: 379, name: '雷吉斯奇鲁', types: ['钢'], role: 'legendary', flavor: '钢之巨人，坚硬的身体能反弹一切攻击。' },
  ],
...
const magma: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 126, name: '鸭嘴火兽', types: ['火'], role: 'encounter', flavor: '从火山口诞生的宝可梦，体内流动着 1200 度的岩浆。' },
    { id: 218, name: '熔岩虫', types: ['火'], role: 'encounter', flavor: '软乎乎的身体一碰就会碎裂，靠分泌岩浆维生。' },
    { id: 324, name: '煤炭龟', types: ['火'], role: 'encounter', flavor: '甲壳里装满煤炭，喷出的烟能把天空染黑。' },
    { id: 58, name: '卡蒂狗', types: ['火'], role: 'encounter', flavor: '忠诚勇敢的宝可梦，奔跑时鬃毛会像火焰一样飘动。' },
    { id: 59, name: '风速狗', types: ['火'], role: 'encounter', flavor: '传说中的奔驰之兽，一天能跑一万公里。' },
  ],
  starterLine: [
    { id: 4, name: '小火龙', types: ['火'], role: 'mascot', flavor: '尾巴上的火焰代表它的心情，火焰旺盛时说明它精神饱满。' },
    { id: 5, name: '火恐龙', types: ['火'], role: 'encounter', flavor: '脾气变得暴躁，尾巴的火焰比小火龙时更旺。' },
    { id: 6, name: '喷火龙', types: ['火', '飞行'], role: 'encounter', flavor: '据说喷出的火焰能融化岩石，是火山天空的霸主。' },
  ],
  legendaries: [
    { id: 146, name: '火焰鸟', types: ['火', '飞行'], role: 'legendary', flavor: '传说中的火之鸟，振翅时羽毛如火焰般燃烧。' },
    { id: 383, name: '固拉多', types: ['地面'], role: 'legendary', flavor: '传说中扩张大地的宝可梦，与盖欧卡势不两立。' },
    { id: 485, name: '席多蓝恩', types: ['火', '钢'], role: 'legendary', flavor: '栖息在火山口的传说宝可梦，体内流动着熔岩般的血液。' },
  ],
...
const snowfield: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 471, name: '冰伊布', types: ['冰'], role: 'encounter', flavor: '能把呼出的气冻结成冰晶，撒向空中形成美丽的冰雾。' },
    { id: 144, name: '急冻鸟', types: ['冰', '飞行'], role: 'encounter', flavor: '传说中的冰之鸟，飞过之处会降下暴风雪。' },
    { id: 363, name: '海豹球', types: ['冰', '水'], role: 'encounter', flavor: '圆滚滚的身体在冰面上滚来滚去，靠吃海里的鱼为生。' },
    { id: 220, name: '小山猪', types: ['冰', '地面'], role: 'encounter', flavor: '冬天溜进雪原翻找食物的宝可梦，鼻子冻得通红也不在意。' },
    { id: 361, name: '雪童子', types: ['冰'], role: 'encounter', flavor: '戴着岩石面具的宝可梦，据说面具下藏着惊天的秘密。' },
  ],
  starterLine: [
    { id: 361, name: '雪童子', types: ['冰'], role: 'encounter', flavor: '戴着岩石面具的宝可梦，据说面具下藏着惊天的秘密。' },
    { id: 362, name: '冰鬼护', types: ['冰'], role: 'encounter', flavor: '巨大的下颚能咬碎钢铁，呼气能冻结一切。' },
    { id: 459, name: '雪笠怪', types: ['草', '冰'], role: 'encounter', flavor: '栖息在雪山深处，摇摆的身体像一片会走路的积雪。' },
  ],
  legendaries: [
    { id: 646, name: '酋雷姆', types: ['龙', '冰'], role: 'legendary', flavor: '最强的龙之一，能吸收捷克罗姆或莱希拉姆合体，吐息能冻结世界。' },
    { id: 378, name: '雷吉艾斯', types: ['冰'], role: 'legendary', flavor: '冰之巨人，身边永远环绕着零下 200 度的冷气。' },
    { id: 144, name: '急冻鸟', types: ['冰', '飞行'], role: 'legendary', flavor: '传说中的冰之鸟，飞过之处会降下暴风雪。' },
  ],
...
const plant: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 25, name: '皮卡丘', types: ['电'], role: 'encounter', flavor: '两颊的电气袋储存着电力，生气时会一口气放出来。' },
    { id: 81, name: '小磁怪', types: ['电', '钢'], role: 'encounter', flavor: '被发电厂的电磁波吸引而来，吸附在设备上一动不动。' },
    { id: 125, name: '电击兽', types: ['电'], role: 'encounter', flavor: '双臂能放出 2 万伏特的高压电，是发电厂的常客。' },
    { id: 100, name: '雷电球', types: ['电'], role: 'encounter', flavor: '外形酷似精灵球，常被误捡——发电厂事故的常客。' },
    { id: 26, name: '雷丘', types: ['电'], role: 'encounter', flavor: '皮卡丘的进化型，尾巴能吸收大气中的电能。' },
  ],
  starterLine: [
    { id: 172, name: '皮丘', types: ['电'], role: 'encounter', flavor: '电气袋还没发育完全，一吃惊就会漏电把自己吓一跳。' },
    { id: 25, name: '皮卡丘', types: ['电'], role: 'mascot', flavor: '两颊的电气袋储存着电力，生气时会一口气放出来。' },
    { id: 26, name: '雷丘', types: ['电'], role: 'encounter', flavor: '皮卡丘的进化型，尾巴能吸收大气中的电能。' },
  ],
  legendaries: [
    { id: 145, name: '闪电鸟', types: ['电', '飞行'], role: 'legendary', flavor: '雷云中的传说鸟宝可梦，拍动翅膀就会落下闪电。' },
    { id: 243, name: '雷公', types: ['电'], role: 'legendary', flavor: '传说中的雷电之兽，奔跑时雷声轰鸣。' },
    { id: 807, name: '捷拉奥拉', types: ['电'], role: 'legendary', flavor: '幻之电猫，出拳速度超越音速。' },
  ],
...
const space: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 386, name: '代欧奇希斯', types: ['超能力'], role: 'encounter', flavor: '宇宙病毒的 DNA 突变而成的宝可梦，能自由变换四种形态。' },
  ],
  starterLine: [
  ...
  legendaries: [
    { id: 384, name: '烈空坐', types: ['龙', '飞行'], role: 'legendary', flavor: '栖息在臭氧层的传说宝可梦，以陨石为食，能平息固拉多与盖欧卡的争斗。' },
    { id: 250, name: '凤王', types: ['火', '飞行'], role: 'legendary', flavor: '传说中的虹色宝可梦，飞过之处会留下彩虹。' },
...
const city: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 133, name: '伊布', types: ['一般'], role: 'encounter', flavor: '拥有不稳定的遗传基因，会根据环境进化成各种形态。' },
    { id: 143, name: '卡比兽', types: ['一般'], role: 'encounter', flavor: '整天只顾睡觉的大胃王，据说一个月要吃 400 公斤食物。' },
    { id: 448, name: '路卡利欧', types: ['格斗', '钢'], role: 'encounter', flavor: '能读懂波导的宝可梦，是城市训练家最信赖的搭档。' },
    { id: 94, name: '耿鬼', types: ['幽灵', '毒'], role: 'encounter', flavor: '喜欢躲在城市阴暗角落吓唬路人的恶作剧大师。' },
    { id: 658, name: '甲贺忍蛙', types: ['水', '恶'], role: 'encounter', flavor: '如忍者般神出鬼没，据说会在高楼的影子间穿梭。' },
  ],
  starterLine: [
    { id: 133, name: '伊布', types: ['一般'], role: 'mascot', flavor: '拥有不稳定的遗传基因，会根据环境进化成各种形态。' },
    { id: 25, name: '皮卡丘', types: ['电'], role: 'encounter', flavor: '城市里最随处可见的电气鼠，深受训练家喜爱。' },
    { id: 448, name: '路卡利欧', types: ['格斗', '钢'], role: 'encounter', flavor: '能读懂波导的宝可梦，是城市训练家最信赖的搭档。' },
  ],
  legendaries: [
    { id: 151, name: '梦幻', types: ['超能力'], role: 'legendary', flavor: '拥有所有宝可梦基因的幻之宝可梦，据说只有心地纯洁的人才能见到它。' },
...
const lab: SceneDef = {
  ...
  pokemon: [
    ...
    { id: 386, name: '代欧奇希斯', types: ['超能力'], role: 'encounter', flavor: '宇宙病毒的 DNA 突变而成的宝可梦，能自由变换四种形态。' },
    { id: 571, name: '索罗亚', types: ['恶'], role: 'encounter', flavor: '能变成任何模样的幻影宝可梦，实验室里最让人头疼的捣蛋鬼。' },
  ],
  starterLine: [
    { id: 374, name: '铁哑铃', types: ['钢', '超能力'], role: 'encounter', flavor: '靠磁力浮在空中，成群聚集时会共享脑电波。' },
    { id: 375, name: '金属怪', types: ['钢', '超能力'], role: 'encounter', flavor: '两只铁哑铃合体而成，四只手臂能抓住飞行中的猎物。' },
    { id: 376, name: '巨金怪', types: ['钢', '超能力'], role: 'encounter', flavor: '拥有超越超级计算机的头脑，是实验室最理想的助手。' },
  ],
  legendaries: [
    { id: 150, name: '超梦', types: ['超能力'], role: 'legendary', flavor: '由梦幻的基因人工制造的宝可梦，拥有最强大的战斗能力，却对人类充满疑问。' },
